...
async function runCli(app: App): Promise<void> {
  ...
  console.log(
    "type /help, /status, /new, /resume <session-id>, /session list [--project <path>], /stop, /project, /project list, /project bind <path>, /approvals [...], /log [-n N] [--since <expr>] [--grep <text>], or plain prompts"
  );
